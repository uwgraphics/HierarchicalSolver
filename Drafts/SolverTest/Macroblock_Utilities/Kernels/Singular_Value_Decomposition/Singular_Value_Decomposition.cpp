...
#ifndef SUBROUTINE_Singular_Value_Decomposition
#define INSTANCE_KERNEL_Singular_Value_Decomposition(WIDTH) const WIDETYPE(float,WIDTH) (&A)[9], WIDETYPE(float,WIDTH) (&U)[9], WIDETYPE(float,WIDTH) (&S)[3], WIDETYPE(float,WIDTH) (&V)[9]
