...
public:
    ...
    using BASE::Find_Ghost_Regions;using BASE::Boundary;using BASE::fixed_boundary_value;
...
//#####################################################################
    ...
    virtual void Fill_Single_Ghost_Region(const T_GRID& grid,T_ARRAYS_T2& u_ghost,const int side,const T dt,const T time,const RANGE<TV_INT>& region) const PHYSBAM_OVERRIDE ;
