...
public:
    ...
    using POISSON_UNIFORM<T_GRID>::psi_N;using POISSON_UNIFORM<T_GRID>::psi_D;using POISSON_UNIFORM<T_GRID>::periodic_boundary;
    ...
    using LAPLACE_UNIFORM<T_GRID>::Find_A;using LAPLACE_UNIFORM<T_GRID>::Find_Tolerance;
#ifdef USE_PTHREADS
    using LAPLACE_UNIFORM<T_GRID>::lock;using LAPLACE_UNIFORM<T_GRID>::barr;
#endif
    using LAPLACE_UNIFORM<T_GRID>::u;using LAPLACE_UNIFORM<T_GRID>::f;
